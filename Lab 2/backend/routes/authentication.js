...
router.post('/createBasicUser', function(req, res) {
    kafka.make_request('auth', {"method": "post_createBasic", "msg": req.body}, function(error, result) {
        if (error) {
            console.log(error)
...
router.post('/login', function(req, res) {
    kafka.make_request('auth', {"method": "login", "msg": req.body}, function(error, result) {
        if (error) {
            console.log(error)
